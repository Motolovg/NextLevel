...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'nextLevel';
    ...
    'jhipster.mail.from' = 'nextLevel@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'nextLevel API';
    'jhipster.swagger.description' = 'nextLevel API documentation';
    ...
    'eureka.instance.appname' = 'nextLevel';
    'eureka.instance.instanceId' = 'nextLevel:${random.value}';
